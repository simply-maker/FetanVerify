        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">FetanVerify</span>
            </div>
            <p className="text-gray-400 mb-4">
              Secure, fast, and reliable verification services for businesses worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">support@fetanverify.com</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Verification St<br />Tech City, TC 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 FetanVerify. All rights reserved.
            </p>
